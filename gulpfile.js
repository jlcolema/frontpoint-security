...
gulp.task('watch', function() {
	...
	browsersync.init({
		...
		proxy: "http://frontpointsecurity.local",
		host: "frontpointsecurity.local",
		open: "external"
	...
	gulp.watch(basePaths.root + '**/*.html').on('change', browsersync.reload);
...
gulp.task('default', ['sass', 'img', 'fonts', 'watch']);
